...
from acts.examples.odd import getOpenDataDetector, getOpenDataDetectorDirector
...
parser.add_argument(
    ...
    type=pathlib.Path,
    default=pathlib.Path.cwd() / "odd_output_tau3mu",
)
...
oddDigiConfig = (
    args.digi_config
    if args.digi_config
    else actsDir / "Examples/Configs/odd-geometric-geometric-config.json"
)
